...
const ZH: Dict = {
  ...
  "sniffer.adText": "定制开发 · 项目合作",
  "sniffer.urlPlaceholder": "粘贴视频页 URL, 点「捕获」用内置浏览器打开(抖音等需签名的站点)",
  "sniffer.btnCapture": "捕获",
  "sniffer.btnResolve": "解析",
  "sniffer.resolving": "解析中…",
  "sniffer.resolveFailed": "解析失败",
  "sniffer.resolveNote": "解析完成: 已合并 {n} 个清晰度到下方列表",
  "sniffer.resolveNone": "未找到可用清晰度",
  "sniffer.fmtBest": "最佳视频(MP4·最高分辨率)",
  "sniffer.fmtBestAudio": "最佳音频",
  "sniffer.fmtDownload": "下载",
  "sniffer.fmtAdded": "已加入下载列表",
  "sniffer.chkPopup": "弹窗",
  ...
  "set.updateYtDlp": "更新 yt-dlp",
  "set.aboutGroup": "关于",
  "set.version": "软件版本",
  "set.checkUpdate": "检查更新",
  "set.checking": "检查中…",
  "update.found": "发现新版本 v{ver},",
  "update.latest": "已是最新版本",
  "update.openRelease": "查看新版本",
  "update.checkFailed": "检查失败(网络), 请稍后重试",
...
const EN: Dict = {
  ...
  "sniffer.adText": "Custom Dev · Collaboration",
  ...
  "sniffer.btnResolve": "Resolve",
  "sniffer.resolving": "Resolving…",
  "sniffer.resolveFailed": "Resolve failed",
  "sniffer.resolveNote": "Resolved: {n} formats merged into the list below",
  "sniffer.resolveNone": "No available formats found",
  "sniffer.fmtBest": "Best video (MP4·highest res)",
  "sniffer.fmtBestAudio": "Best audio",
  "sniffer.fmtDownload": "Download",
  "sniffer.fmtAdded": "Added to downloads",
  ...
  "update.found": "New version v{ver} available,",
  "update.latest": "You are up to date",
  "update.openRelease": "view release",
  "update.checkFailed": "Check failed (network), try again later",
